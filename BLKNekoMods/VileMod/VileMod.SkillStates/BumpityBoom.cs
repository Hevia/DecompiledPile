...
public class BumpityBoom : BaseSkillState
{
	...
	public override void OnEnter()
	{
		...
		((EntityState)this).PlayAnimation("RightArm, Override", "GranadeR", "attackSpeed", duration);
	}
	...
	public override void FixedUpdate()
	{
		...
		{
			BumpityBoom2 nextState = new BumpityBoom2();
